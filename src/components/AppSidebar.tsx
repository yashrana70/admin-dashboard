...
import { Home, User, BookOpenCheck, BarChart3, Calendar, CalendarDays, LogOut, Shield, ListChecks, Trophy, Network, BookOpen } from "lucide-react";
import {
    ...
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="border-t border-sidebar-border p-2">
        <Button variant="ghost" size="sm" onClick={signOut}
          className="text-sidebar-foreground hover:bg-sidebar-accent justify-start gap-2">
