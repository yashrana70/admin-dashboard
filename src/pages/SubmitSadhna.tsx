...
const schema = z.object({
  ...
  facilitator_name: z.string().trim().min(2).max(100),
...
export default function SubmitSadhna() {
  ...
  useEffect(() => {
    ...
    supabase.from("profiles")
      .select("facilitator_name,full_name,devotee_level,bhakti_vriksha_level")
      ...
      .then(({ data }) => {
        ...
        setF(prev => ({
          ...prev,
          facilitator_name: prev.facilitator_name || d.facilitator_name || "",
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Card className="shadow-elegant">
        ...
        <CardContent className="grid md:grid-cols-2 gap-4">
          ...
          <div><Label>Facilitator Name *</Label><Input required value={f.facilitator_name} onChange={e => setF({ ...f, facilitator_name: e.target.value })} /></div>
      ...
      {shared && (
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="p-4 text-sm">
            🪔 Submitted! Use the share buttons above to send your report to your facilitator.
          </CardContent>
        </Card>
      )}
